...
//
// So, for example:
//  + (id)xml_nodeConsumingXMLNode:(xmlNodePtr)theXMLNode;
...
+ (id)xml_nodeConsumingXMLNode:(xmlNodePtr)theXMLNode;
- (id)xml_initConsumingXMLNode:(xmlNodePtr)theXMLNode;

+ (id)xml_nodeBorrowingXMLNode:(xmlNodePtr)theXMLNode;
- (id)xml_initBorrowingXMLNode:(xmlNodePtr)theXMLNode;

// getters of the underlying node
- (xmlNodePtr)xml_XMLNode;
- (xmlNodePtr)xml_XMLNodeCopy;

// search for an underlying attribute
- (GDataXMLNode *)xml_attributeForXMLNode:(xmlAttrPtr)theXMLNode;

// return an NSString for an xmlChar*, using our strings cache in the
// document
- (NSString *)xml_stringFromXMLString:(const xmlChar *)chars;

// setter/getter of the dealloc flag for the underlying node
- (BOOL)xml_shouldFreeXMLNode;
- (void)xml_setShouldFreeXMLNode:(BOOL)flag;

@end

@interface GDataXMLElement (PrivateMethods)

+ (void)xml_fixUpNamespacesForNode:(xmlNodePtr)nodeToFix
...
+ (GDataXMLElement *)elementWithName:(NSString *)name
{
  ...
  if (theNewNode) {
    // succeeded
    return [self xml_nodeConsumingXMLNode:theNewNode];
  }
  return nil;
}
...
+ (GDataXMLElement *)elementWithName:(NSString *)name URI:(NSString *)theURI
{
  ...
  // a proper namespace ptr later when addChild calls xml_fixUpNamespacesForNode
...
+ (id)attributeWithName:(NSString *)name stringValue:(NSString *)value
{
  ...
  xmlAttrPtr theNewAttr = xmlNewProp(NULL, // parent node for the attr
                                     xmlName, xmlValue);
  if (theNewAttr) {
    return [self xml_nodeConsumingXMLNode:(xmlNodePtr) theNewAttr];
  }
...
+ (id)textWithStringValue:(NSString *)value
{
  ...
  if (theNewText) {
    return [self xml_nodeConsumingXMLNode:theNewText];
  }
  return nil;
}
...
+ (id)namespaceWithName:(NSString *)name stringValue:(NSString *)value
{
  ...
  xmlNsPtr theNewNs = xmlNewNs(NULL, // parent node
                               href, prefix);
  if (theNewNs) {
    return [self xml_nodeConsumingXMLNode:(xmlNodePtr) theNewNs];
  }
  return nil;
}
...
+ (id)xml_nodeConsumingXMLNode:(xmlNodePtr)theXMLNode
{
  ...
  return [[[theClass alloc] xml_initConsumingXMLNode:theXMLNode] autorelease];
}
...
+ (id)xml_nodeBorrowingXMLNode:(xmlNodePtr)theXMLNode
{
  ...
  return [[[theClass alloc] xml_initBorrowingXMLNode:theXMLNode] autorelease];
}
...
- (NSString *)stringValue
{
  ...
  if (xmlNode_ != NULL) {
    ...
    if (xmlNode_->type == XML_NAMESPACE_DECL) {
      ...
      str = [self xml_stringFromXMLString:(nsNode->href)];
      ...
      if (chars) {
        ...
        str = [self xml_stringFromXMLString:chars];
...
- (NSString *)localName
{
  ...
  if (xmlNode_ != NULL) {
    ...
    str = [self xml_stringFromXMLString:(xmlNode_->name)];
...
- (NSString *)prefix
{
  ...
  if (xmlNode_ != NULL) {
    ...
    if (xmlNode_->ns != NULL && xmlNode_->ns->prefix != NULL) {
      str = [self xml_stringFromXMLString:(xmlNode_->ns->prefix)];
    }
  }
  return str;
}
...
- (NSString *)URI
{
  ...
  if (xmlNode_ != NULL) {
    ...
    if (xmlNode_->ns != NULL && xmlNode_->ns->href != NULL) {
      str = [self xml_stringFromXMLString:(xmlNode_->ns->href)];
    }
  }
  return str;
}
  ...
  if (xmlNode_ != NULL) {
    if (xmlNode_->type == XML_NAMESPACE_DECL) {
      ...
      if (nsNode->prefix == NULL) {
        ...
        str = [self xml_stringFromXMLString:(nsNode->prefix)];
      }
      ...
      if (asprintf(&qname, "%s:%s", (const char *)xmlNode_->ns->prefix,
                   xmlNode_->name) != -1) {
        str = [self xml_stringFromXMLString:(const xmlChar *)qname];
        free(qname);
      }
    } else {
      // lacks a prefix
...
- (NSArray *)children
{
  ...
  if (xmlNode_ != NULL) {
    ...
    while (currChild != NULL) {
      GDataXMLNode *node = [GDataXMLNode xml_nodeBorrowingXMLNode:currChild];
      ...
      if (xpathObj) {
        ...
        if (nodeSet) {
          ...
          for (int index = 0; index < nodeSet->nodeNr; index++) {
            ...
            GDataXMLNode *node = [GDataXMLNode xml_nodeBorrowingXMLNode:currNode];
            if (node) {
              [array addObject:node];
            }
          }
...
- (id)copyWithZone:(NSZone *)zone
{
  ...
  xmlNodePtr nodeCopy = [self xml_XMLNodeCopy];

  if (nodeCopy != NULL) {
    return [[[self class] alloc] xml_initConsumingXMLNode:nodeCopy];
  }
  return nil;
}
...
- (BOOL)isEqual:(GDataXMLNode *)other
{
  ...
  return [self xml_XMLNode] == [other xml_XMLNode]
...
- (id)initWithXMLString:(NSString *)str error:(NSError **)error
{
  ...
  if (self) {
    ...
    if (doc == NULL) {
      if (error) {
          NSLog(@"GDataXMLElement initWithXMLString error:%@", *error);
      }
    } else {
  ...
  if (xmlNode_ != NULL && xmlNode_->nsDef != NULL) {
    ...
    while (currNS != NULL) {
      ...
      if (!xmlStrEqual(currNS->prefix, (const xmlChar *) "xml")) {
        GDataXMLNode *node = [GDataXMLNode xml_nodeBorrowingXMLNode:(xmlNodePtr) currNS];
...
- (void)setNamespaces:(NSArray *)namespaces
{
  ...
  if (xmlNode_ != NULL) {
    ...
    while ((namespace = [enumerator nextObject]) != nil) {
      ...
      xmlNsPtr ns = (xmlNsPtr) [namespace xml_XMLNode];
      if (ns) {
    ...
    [[self class] xml_fixUpNamespacesForNode:xmlNode_
...
- (void)addNamespace:(GDataXMLNode *)aNamespace
{
  ...
  if (xmlNode_ != NULL) {
    ...
    xmlNsPtr ns = (xmlNsPtr) [aNamespace xml_XMLNode];
    if (ns) {
      (void)xmlNewNs(xmlNode_, ns->href, ns->prefix);
...
- (void)addChild:(GDataXMLNode *)child
{
  ...
  if (xmlNode_ != NULL) {
    ...
    xmlNodePtr childNodeCopy = [child xml_XMLNodeCopy];
    if (childNodeCopy) {
      ...
      if (resultNode == NULL) {
        ...
        [[self class] xml_fixUpNamespacesForNode:childNodeCopy
                          graftingToTreeNode:xmlNode_];
      }
    }
  }
...
- (void)removeChild:(GDataXMLNode *)child
{
  ...
  if (xmlNode_ != NULL) {
    ...
    xmlNodePtr node = [child xml_XMLNode];
    ...
    // free it on dealloc
    if (![child xml_shouldFreeXMLNode]) {
      xmlFreeNode(node);
    }
  }
}
  ...
  if (xmlNode_ != NULL) {
    ...
    if (prefix) {
      ...
      if (foundNS) {
        ...
        // to get the elements
        NSString *desiredURI = [self xml_stringFromXMLString:(foundNS->href)];
    ...
    for (GDataXMLNode *child in children) {
      ...
      xmlNodePtr currNode = [child xml_XMLNode];
...
- (NSArray *)elementsForLocalName:(NSString *)localName URI:(NSString *)URI
{
  ...
  if (xmlNode_ != NULL && xmlNode_->children != NULL) {
    ...
    for (GDataXMLNode *child in children) {
      ...
      xmlNodePtr currChildPtr = [child xml_XMLNode];
...
- (NSArray *)attributes
{
  ...
  if (xmlNode_ != NULL && xmlNode_->properties != NULL) {
    ...
    while (prop != NULL) {
      ...
      GDataXMLNode *node = [GDataXMLNode xml_nodeBorrowingXMLNode:(xmlNodePtr) prop];
      if (array == nil) {
        array = [NSMutableArray arrayWithObject:node];
      } else {
        [array addObject:node];
...
- (void)addAttribute:(GDataXMLNode *)attribute
{
  ...
  if (xmlNode_ != NULL) {
    ...
    xmlAttrPtr attrPtr = (xmlAttrPtr) [attribute xml_XMLNode];
    if (attrPtr) {
      ...
      if (oldAttr == NULL) {
        ...
        if (newProp != NULL) {
          ...
          [[self class] xml_fixUpNamespacesForNode:(xmlNodePtr)newProp
                            graftingToTreeNode:xmlNode_];
        }
...
- (GDataXMLNode *)xml_attributeForXMLNode:(xmlAttrPtr)theXMLNode
{
  ...
  for (GDataXMLNode *attr in attributes) {
    ...
    if (theXMLNode == (xmlAttrPtr) [attr xml_XMLNode]) {
      return attr;
    }
  }
...
- (GDataXMLNode *)attributeForName:(NSString *)name
{
  ...
  if (xmlNode_ != NULL) {
    ...
    if (attrPtr) {
      GDataXMLNode *attr = [self xml_attributeForXMLNode:attrPtr];
      return attr;
    }
  }
  return nil;
  ...
  if (xmlNode_ != NULL) {
    ...
    if (foundNS) {
      ...
      if (foundNS->prefix != NULL) {
        NSString *prefix = [self xml_stringFromXMLString:(foundNS->prefix)];
        return prefix;
      } else {
              ...
              graftingToTreeNode:(xmlNodePtr)graftPointNode
{
  ...
  //
  // This is an inner routine for xml_fixUpNamespacesForNode:
  //
      ...
      namespaceSubstitutionMap:(NSMutableDictionary *)nsMap
{
  ...
  // This is the inner routine for xml_fixUpNamespacesForNode:graftingToTreeNode:
  //
  ...
  if (nodeToFix->type == XML_ELEMENT_NODE) {
    ...
    while (currChild != NULL) {
      [self xml_fixUpNamespacesForNode:currChild
                graftingToTreeNode:graftPointNode
          namespaceSubstitutionMap:nsMap];
      currChild = currChild->next;
    }
    ...
    while (currProp != NULL) {
      [self xml_fixUpNamespacesForNode:(xmlNodePtr)currProp
                graftingToTreeNode:graftPointNode
          namespaceSubstitutionMap:nsMap];
            ...
            graftingToTreeNode:(xmlNodePtr)graftPointNode
{
  ...
  [self xml_fixUpNamespacesForNode:nodeToFix
            graftingToTreeNode:graftPointNode
      namespaceSubstitutionMap:nsMap];
}
...
- (id)initWithRootElement:(GDataXMLElement *)element
{
  ...
  if (self) {
    ...
    (void) xmlDocSetRootElement(xmlDoc_, [element xml_XMLNodeCopy]);
...
- (GDataXMLElement *)rootElement
{
  ...
  if (xmlDoc_ != NULL) {
    ...
    if (rootNode) {
      element = [GDataXMLElement xml_nodeBorrowingXMLNode:rootNode];
    }
  }
  return element;
}
...
{
  if (xmlDoc_ != NULL) {
    GDataXMLNode *docNode = [GDataXMLElement xml_nodeBorrowingXMLNode:(xmlNodePtr)xmlDoc_];
